package com.example.shilpa.inventoryapp;
...
import com.example.shilpa.inventoryapp.data.InventoryContract.InventoryEntry;
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.supplier_IKEA))) {
                        mSupplieName = InventoryEntry.SUPPLIER_IKEA;
                    } else if (selection.equals(getString(R.string.supplier_SHOPIFY))) {
                        mSupplieName = InventoryEntry.SUPPLIER_SHOPIFY;
                    } else if (selection.equals(getString(R.string.supplier_HOMEDEPOT))) {
                        mSupplieName = InventoryEntry.SUPPLIER_HOMEDEPOT;
                    } else {
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                case InventoryEntry.SUPPLIER_IKEA:
                    ...
                    break;
                case InventoryEntry.SUPPLIER_SHOPIFY:
                    mProductSupplieNameSpinner.setSelection(2);
                    break;
                case InventoryEntry.SUPPLIER_HOMEDEPOT:
