        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                case InventoryEntry.SUPPLIER_IKEA:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_IKEA));
                    break;
                case InventoryEntry.SUPPLIER_SHOPIFY:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_SHOPIFY));
                    break;
                case InventoryEntry.SUPPLIER_HOMEDEPOT:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_HOMEDEPOT));
                    break;
                default:
