...
public class InventoryCursorAdapter extends CursorAdapter {
    ...
    public void bindView(final View view, final Context context, final Cursor cursor) {
        ...
        productPriceTextView.setText(context.getString(R.string.price_of_product) + " : " + productPrice + "  " + context.getString(R.string.price_of_product));
        productQuantityTextView.setText(context.getString(R.string.quantity_of_product) + " : " + productQuantity);
